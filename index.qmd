...
<iframe src="https://docs.google.com/presentation/d/e/2PACX-1vQf6dWJNvEFKmU4v5SdAjgL74fJwlvLELeptMywYPykl-juU4kGQDMyM-i_nmc1S631f2q3rH_4EAHS/pubembed?start=false&loop=false&delayms=3000" frameborder="0" width="1000" height="800" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>
...
3. *Liveness*- Detects the presence of an audience in the recording. Higher liveness values represent an increased probability that the track was performed live. A value above 0.8 provides strong likelihood that the track is live.
...
[^1]: [What Do the Audio Features Mean](https://help.spotontrack.com/article/what-do-the-audio-features-mean)

[^2]: [Spotify Popularity Index](https://www.artist.tools/features/spotify-popularity-index)
...
```{r, fig.alt = "Scatterplot showing the relationship between the 'max' audio feature and Spotify popularity for top songs, colored by audio feature category."}
audioFeaturesTop %>%
  ggplot(aes(x = max, y = spotify_track_popularity, color = maxCat)) +
  geom_point() + 
  labs(
    title = "Top Songs",
    subtitle = "Songs with Spotify popularity score over 85",
    x = "Max Audio Feature Value",
    y = "Spotify Track Popularity",
    color = "Dominant Feature",
    caption = "Created by Martha, Ava, Yu, Jay | May 10, 2025 | Data source: TidyTuesday"
      ) +
...
```{r, fig.alt = "Scatterplot showing the relationship between the 'max' audio feature and Spotify popularity for bottom songs, colored by audio feature category."}
audioFeaturesBottom %>%
  ggplot(aes(x = max, y = spotify_track_popularity, color = maxCat)) +
  geom_point() + 
  labs(
    title = "Bottom Songs",
    subtitle = "Songs with Spotify popularity score below 15",
    x = "Max Audio Feature Value",
    y = "Spotify Track Popularity",
    color = "Dominant Feature",
    caption = "Created by Martha, Ava, Yu, Jay | May 10, 2025 | Data source: TidyTuesday"
...
```{r, fig.alt = "Scatterplot showing the relationship between the 'max' audio feature and Spotify popularity for all songs, colored by audio feature category."}
audioFeatures %>%
  ggplot(aes(x = max, y = spotify_track_popularity, color = maxCat)) +
  geom_point() + 
  labs(
    title = "All Songs",
    subtitle = "All songs colored by dominant audio feature",
    x = "Max",
    y = "Spotify Track Popularity",
    color = "Dominant Feature",
    caption = "Created by Martha, Ava, Yu, Jay | May 10, 2025 | Data source: TidyTuesday"
...
```{r, fig.alt = "Bar chart showing audio features for the top song \"Dance Monkey\""}
audioFeatures |>
  filter(spotify_track_popularity == 100, song == "Dance Monkey") |>
  ...
  labs(
    title = "Dance Monkey Audio Features", 
    subtitle = "Top Song",
    caption = "Created by Martha, Ava, Yu, Jay | May 10, 2025 | Data source: TidyTuesday") +
  theme(plot.title = element_text(size=22, face = "bold"), 
        axis.text = element_text(size = 8),
...
```{r, fig.alt = "Bar chart showing audio features for the bottom song \"Goldfinger\""}
audioFeatures |>
  ...
  scale_fill_manual(values = c("#ccff33", "#9ef01a", "#9ef01a", "#38b000", "#008000", "#007200", "#006400")) +
  labs(
    title = "Goldfinger Audio Features", 
    subtitle = "Bottom Song",
    caption = "Created by Martha, Ava, Yu, Jay | May 10, 2025 | Data source: TidyTuesday") +
  theme(plot.title = element_text(size=22, face = "bold"), 
        axis.text = element_text(size = 8),
        axis.title = element_text(size = 12, face = "bold"),
...
Our report : [Video Report](https://www.youtube.com/watch?v=0sk6iWK15po)
