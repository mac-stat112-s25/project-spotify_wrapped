...
*Data acquisition* - The data was downloaded directly from the TidyTuesday GitHub repository, and imported into our local RStudio session for analysis. The data orginates from Spotify and hosted by TidyTuesday.
